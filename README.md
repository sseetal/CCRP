...
create a sheet and get the id
https://blog.stephsmith.io/tutorial-google-sheets-api-node-js/: Step 3
Share the sheet with the email created (last step of instructions
save credentials as google.json